export default function PropertyCard() {
    return (
        <div>
            <div className="sm:min-w-500 sm:w-full sm:flex-shrink-0 sm:px-2">
                <div className="relative pb-5/6">
                    <img className="absolute inset-0 h-full w-full rounded-lg shadow-md object-cover"
            ...
            <div className="relative px-4 -mt-16">
                <div className="bg-white rounded-lg shadow-lg px-4 py-4">
                    ...
                    <div className="mt-2 flex items-center text-sm text-gray-600">
                        {/*Stars*/}
                        <svg className="h-4 w-4 fill-current text-teal-500" viewBox="0 0 24 24"
