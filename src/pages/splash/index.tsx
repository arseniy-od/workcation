...
export default function Splash() {
    return (
        <div id="splash" className="min-h-screen bg-gray-100 antialiased">
            <Head>
            ...
            <div className="px-8 py-12 max-w-xl mx-auto lg:max-w-full lg:px-0 lg:py-20 lg:relative lg:min-h-screen">
                <div className="lg:mx-auto lg:w-7/12 lg:pl-12 lg:pr-8 xl:max-w-5xl">
                    ...
                    <div className="mt-8 lg:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12">
                        <img className="rounded-lg shadow-xl w-full object-cover object-center sm:h-56 lg:inset-0 lg:h-full lg:object-left lg:shadow-none lg:rounded-none"
                             src="/images/beach_work.jpg" alt="Woman at the beach with laptop"/>
                        <svg className="hidden lg:block absolute inset-y-0 left-0 w-16 h-full" viewBox="0 0 100 100" preserveAspectRatio="none" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <polygon className="text-gray-100" fill="currentColor" points="0,0 0,100 100,0"/>
                        </svg>
                    </div>
                    <h1 className="mt-8 text-3xl font-semibold text-gray-900 leading-tight sm:text-4xl">
                    ...
                    <div className="mt-6">
                        <a href="#"
                           className="px-5 py-3 inline-block bg-indigo-500 text-white font-semibold rounded-lg tracking-wide uppercase shadow-lg hover:bg-indigo-300">Book
                            your escape</a>
                    </div>
                </div>
            </div>
